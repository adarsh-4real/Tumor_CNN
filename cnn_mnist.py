...
plt.savefig('DL-ALGORITHMS/CNN/mnist_sample/results/mnist_accuracy_plot.png')
...
plt.savefig('DL-ALGORITHMS/CNN/mnist_sample/results/mnist_loss_plot.png')
...
submission.to_csv("DL-ALGORITHMS/CNN/mnist_sample/results/MNIST-CNN.csv",index=False)
print("--------------------------------------\n")
